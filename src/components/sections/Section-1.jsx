...
const SectionOne = () => {
	...
	return (
		<div className="Section-1 position-relative mb-3" onMouseLeave={() => setIsItems1(false)}>
			<Row className="mx-0 menu-container h-100 d-none d-md-flex" onMouseLeave={() => setIsLink1(false)}>
				{/* Menu-Col-1 */}
				<Col md={4} lg={3} xl={4} className="px-0">
					<ListGroup className="h-100 bg-white small rounded-0">
						<MenuItem itemName="Electronic Devices 1" onMouseEnter={() => setIsItems1(true)} />
					</ListGroup>
				</Col>
				{/* Menu-Col-1-End */}
				{/* Menu-Col-2 */}

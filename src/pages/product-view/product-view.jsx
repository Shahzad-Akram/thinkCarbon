...
const ProductView = () => {
	...
	const { status, error, data } = useQuery([ 'product', id.id ], getSingleProduct);
		...
		<Container className="px-0 mt-2 mb-4">
			<div className="d-flex flex-column flex-md-row  px-2 px-md-0 align-items-baseline categories-nav border-bottom pb-2">
				...
				<Button variant="link" className="p-0" disabled>
					<small>
						Tecno Spark 5 Pro - 6.6" Dot Display - 4GB RAM - 128GB ROM - 16MP AI Quad Camera - 5000 mAh
						Battery
					</small>
				</Button>
			</div>
			<MagnifierContainer>
				...
				<Row className="product-container mx-0 mb-3 bg-white">
					...
					<Col className="py-3">
						...
						<section className="position-relative">
							<h5 className="mb-3">
								{data.data.name} - 6.6" Dot Display - 4GB RAM - 128GB ROM - 16MP AI Quad Camera - 5000
								mAh Battery
							</h5>
							...
							<div className="small border-bottom pb-3 mb-3">
								<small className="font-weight-bold mr-1 text-black-50">Brand:</small>
						...
						<section className="position-relative border-bottom pb-3 mb-3">
							<h3 className="text-green-light font-weight-bold"> {data.data.price} &#36;</h3>
							<div className="small">
								<small className="font-weight-bold mr-3 text-black-50">Installment</small>
								<span>
									<span className="mr-2">
						...
						<section className="position-relative">
							<div className="d-flex align-items-baseline mb-3 ">
								<small className="font-weight-bold mr-3 text-black-50">Color Family</small>
								<div>
									<small className="position-relative">
										Please select the option
										<span
											className={
												productItem1 ? 'd-inline-block mx-1 product-item-wrap' : 'd-none'
											}
										>
											Ice Jadeite
										</span>
										<span
											className={
												productItem2 ? 'd-inline-block mx-1 product-item-wrap' : 'd-none'
											}
										>
											Seabed Blue
										</span>
							...
							<div className="d-flex align-items-baseline">
								<small className="font-weight-bold mr-3 text-black-50">Storage Capacity</small>
								<div>
							...
							<div className="d-flex align-items-center mb-3">
								<small className="font-weight-bold mr-5 text-black-50">Quantity</small>
								...
								<div className="d-flex align-items-center">
									...
									<small className="text-muted ml-3">Only 2 items left</small>
								</div>
							</div>
					...
					<Col lg={3} className="py-3 bg-light">
						<section className="border-bottom pb-3 mb-3">
							<div className="d-flex justify-content-between align-items-baseline small mb-2">
								<small className="font-weight-bold mr-1 text-black-50">Delivery Options</small>
						...
						<section className="border-bottom pb-3 mb-3">
							<div className="d-flex justify-content-between align-items-baseline small mb-3">
								...
								<small className="font-weight-bold mr-1 text-black">Rs. 99</small>
							</div>
							<div className="d-flex justify-content-between align-items-baseline small mb-3">
								<div className="d-flex align-items-center text-black-50">
								...
								<small className="font-weight-bold mr-1 text-black">Rs. 139</small>
							</div>
							<div className="d-flex justify-content-between align-items-baseline small">
								<div className="d-flex align-items-center text-black-50">
									<CashOnDeliveryIcon height={20} />
									<small className="font-weight-bold mr-1 ml-2">Cash on Delivery Available</small>
								</div>
							</div>
						</section>
						<section className="border-bottom pb-3 mb-3">
							<div className="d-flex justify-content-between align-items-baseline small mb-2">
								<small className="font-weight-bold mr-1 text-black-50">Return & Warranty</small>
								<Button variant="link" className="p-0">
									<InfoFillIcon height={13} />
								</Button>
							</div>
							<div className="d-flex justify-content-between align-items-baseline small mb-3">
								<div className="d-flex align-items-center text-black-50">
									...
									<small className="font-weight-bold mr-1 ml-2">100% Authentic</small>
								</div>
							</div>
							<div className="d-flex justify-content-between align-items-baseline small mb-3">
								<div className="d-flex align-items-center text-black-50">
									...
									<small className="font-weight-bold mr-1 ml-2">
										14 days easy return
										<div className="font-weight-normal">Change of mind is not applicable</div>
									</small>
								</div>
							</div>
							<div className="d-flex justify-content-between align-items-baseline small">
								<div className="d-flex align-items-center text-black-50">
									...
									<small className="font-weight-bold mr-1 ml-2">1 Year Brand Warranty</small>
								</div>
							</div>
						</section>
					</Col>
				...
				<section className="product-information mx-0 mb-3 bg-white ">
					<h6 className="bg-light py-3 pl-4 font-weight-bold">
						Product details of Tecno Spark 5 Pro - 6.6" Dot Display - 4GB RAM - 128GB ROM - 16MP AI Quad
						Camera - 5000 mAh Battery
					</h6>
					...
					<div className="pl-5 pb-3 mb-3 border-bottom">
						...
						<small className="d-list-item ml-3 mb-1">6.6" Dot-in Display</small>
						<small className="d-list-item ml-3 mb-1">128GB ROM + 4GB RAM</small>
						<small className="d-list-item ml-3 mb-1">
					...
					<div className="pb-4">
						<h6 className="mb-3 pl-4 font-weight-bold">
							Specifications of Tecno Spark 5 Pro - 6.6" Dot Display - 4GB RAM - 128GB ROM - 16MP AI Quad
							Camera - 5000 mAh Battery
						</h6>
				...
				<section className="product-information mx-0 pb-4 bg-white ">
					<h6 className="bg-light py-3 pl-4 font-weight-bold mb-4">
						Ratings of Tecno Spark 5 Pro - 6.6" Dot Display - 4GB RAM - 128GB ROM - 16MP AI Quad Camera -
						5000 mAh Battery
					</h6>
					<Row className="mx-0">
						<Col lg={3}>
							<h2 className="font-weight-bold mb-1">
								4.8<small className="text-black-50 font-weight-bold">/5</small>
							</h2>
							<div>

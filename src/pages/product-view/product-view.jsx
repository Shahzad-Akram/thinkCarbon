    ...
    <Container className='px-0 mt-2 mb-4'>
      <div className='d-flex flex-column flex-md-row  px-2 px-md-0 align-items-baseline categories-nav border-bottom pb-2'>
        ...
        <Button variant='link' className='p-0' disabled>
          <small>
            Tecno Spark 5 Pro - 6.6" Dot Display - 4GB RAM - 128GB ROM - 16MP AI
            Quad Camera - 5000 mAh Battery
          </small>
        </Button>
      </div>
      <MagnifierContainer>
        <Row className='product-container mx-0 mb-3 bg-white'>
          <Col lg={3} className='py-3'>
            {productItem1 && (
              <div className='product-pos'>
                <div className='product-item border-bottom pb-3 mb-3'>
                  <MagnifierPreview imageSrc='https://static-01.daraz.pk/p/f6a744878b530ad89586d090975aa153.png' />
                </div>
                <div>
            ...
            {productItem2 && (
              <div className='product-pos'>
                <div className='product-item border-bottom pb-3 mb-3'>
                  <MagnifierPreview imageSrc='https://static-01.daraz.pk/p/95c2dfcde08373c07a2afa5bc198476c.png_120x120q80.jpg_.webp' />
                </div>
                <div>
                  <span className='product-item-sm border border-success'>
                    <img
          ...
          <Col className='py-3'>
            <div className='product-item-zoom'>
              {productItem1 && (
                <MagnifierZoom
                  ...
                  style={{ height: '500px' }}
                  imageSrc='https://static-01.daraz.pk/p/f6a744878b530ad89586d090975aa153.png'
                />
              )}
              {productItem2 && (
                <MagnifierZoom
                  className='z-index bg-white shadow-lg rounded-lg'
                  style={{ height: '500px' }}
                  imageSrc='https://static-01.daraz.pk/p/95c2dfcde08373c07a2afa5bc198476c.png_1200x1200q80.jpg_.webp'
                />
              )}
            </div>
            ...
            <section className='position-relative'>
              <h5 className='mb-3'>
                Tecno Spark 5 Pro - 6.6" Dot Display - 4GB RAM - 128GB ROM -
            ...
            <section className='position-relative border-bottom pb-3 mb-3'>
              <h3 className='text-green-light font-weight-bold'>Rs. 26,999</h3>
              <div className='small'>
